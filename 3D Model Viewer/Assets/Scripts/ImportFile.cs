...
public class ImportFile : MonoBehaviour
{
    ...
    private IEnumerator OutputRoutineOpen(string url)
    {
        ...
        else
        {
            ...
            model.transform.localPosition = new Vector3(-5, 0.1f, 0.45f);
    ...
    // Duplicate the size of mesh components, in which the second half of the tringles winding order and normals are reverse of the first half to enable displaying front and back faces
